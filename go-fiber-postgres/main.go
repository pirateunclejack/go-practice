...
import (
	...
	"github.com/pirateunclejack/go-practice/go-fiber-postgres/models"
	"github.com/pirateunclejack/go-practice/go-fiber-postgres/storage"
...
func main() {
	...
	if err != nil {
		log.Printf("could not load the database, error: %v", err)
	}

	err = models.MigrateBooks(db)
	if err != nil {
		log.Printf("could not migrate the database, error: %v", err)
	}
