...
import (
	...
	"github.com/pirateunclejack/go-practice/dynamodb-go-crud/internal/entities/product"
)
...
func (r *Rules) ConvertIoReaderToStruct(
    data io.Reader, model interface{}) (interface{}, error) {
        if data == nil {
