...
const Entries = () => {
  ...
  return(
    <div>
      ...
      <Modal show={addNewEntry} onHide={() => setAddNewEntry(false)} centred='true'>
      ...
      <Modal show={changeIngredient.change} onHide={() => setChangeIngredient({"change": false, "id": 0})} centred='true'>
      <Modal.Header closeButton>
      ...
      <Modal show={changeEntry.change} onHide={() => setChangeEntry({"change": false, "id": 0})} centred='true'>
      <Modal.Header closeButton>
